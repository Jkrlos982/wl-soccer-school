...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'min_age' => 'sometimes|required|integer|min:4|max:25',
            'max_age' => 'sometimes|required|integer|min:4|max:25|gte:min_age',
            'gender' => 'sometimes|required|in:male,female,mixed',
            'max_players' => 'sometimes|required|integer|min:10|max:50',
            'training_days' => 'sometimes|required|array|min:1',
            'training_days.*' => 'in:monday,tuesday,wednesday,thursday,friday,saturday,sunday',
            'training_start_time' => 'sometimes|required|date_format:H:i',
            'training_end_time' => 'sometimes|required|date_format:H:i|after:training_start_time',
